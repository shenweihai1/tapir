...
ssh 127.0.0.1 "ulimit -n 20000;cd tapir;bash r0.sh 27 216 239 $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd tapir;bash r1.sh 28 216 239 $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd tapir;bash r2.sh 29 216 239 $keys"
...
ssh 127.0.0.1     "ulimit -n 20000;cd tapir;bash clients.sh 27 $trd $total_shards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd tapir;bash clients.sh 28 $trd $total_shards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd tapir;bash clients.sh 29 $trd $total_shards $keys" &
