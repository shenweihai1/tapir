...
echo "ssh 20.98.251.234"
ssh 20.98.251.234 "$cmd"
echo "ssh 20.161.4.243"
ssh 20.161.4.243 "$cmd"
echo "ssh 20.119.187.240"
ssh 20.119.187.240 "$cmd"
echo "ssh 20.242.22.50"
ssh 20.242.22.50 "$cmd"
echo "ssh 20.110.131.171"
ssh 20.110.131.171 "$cmd"
echo "ssh 20.119.234.31"
ssh 20.119.234.31 "$cmd"
echo "ssh 20.7.74.198"
ssh 20.7.74.198 "$cmd"
echo "ssh 20.22.210.204"
ssh 20.22.210.204 "$cmd"
echo "ssh 20.119.234.161"
ssh 20.119.234.161 "$cmd"
...
ssh 20.98.251.234 "ulimit -n 20000;cd tapir;bash r0.sh 21 168 191 $keys"
ssh 20.161.4.243 "ulimit -n 20000;cd tapir;bash r1.sh 22 168 191 $keys"
ssh 20.119.187.240 "ulimit -n 20000;cd tapir;bash r2.sh 23 168 191 $keys"
ssh 20.242.22.50 "ulimit -n 20000;cd tapir;bash r0.sh 24 192 215 $keys"
ssh 20.110.131.171 "ulimit -n 20000;cd tapir;bash r1.sh 25 192 215 $keys"
ssh 20.119.234.31 "ulimit -n 20000;cd tapir;bash r2.sh 26 192 215 $keys"
ssh 20.7.74.198 "ulimit -n 20000;cd tapir;bash r0.sh 27 216 239 $keys"
ssh 20.22.210.204 "ulimit -n 20000;cd tapir;bash r1.sh 28 216 239 $keys"
ssh 20.119.234.161 "ulimit -n 20000;cd tapir;bash r2.sh 29 216 239 $keys"
...
ssh 20.98.251.234     "ulimit -n 20000;cd tapir;bash clients.sh 21 $trd $total_shards $keys" &
ssh 20.161.4.243     "ulimit -n 20000;cd tapir;bash clients.sh 22 $trd $total_shards $keys" &
ssh 20.119.187.240     "ulimit -n 20000;cd tapir;bash clients.sh 23 $trd $total_shards $keys" &
ssh 20.242.22.50     "ulimit -n 20000;cd tapir;bash clients.sh 24 $trd $total_shards $keys" &
ssh 20.110.131.171     "ulimit -n 20000;cd tapir;bash clients.sh 25 $trd $total_shards $keys" &
ssh 20.119.234.31     "ulimit -n 20000;cd tapir;bash clients.sh 26 $trd $total_shards $keys" &
ssh 20.7.74.198     "ulimit -n 20000;cd tapir;bash clients.sh 27 $trd $total_shards $keys" &
ssh 20.22.210.204     "ulimit -n 20000;cd tapir;bash clients.sh 28 $trd $total_shards $keys" &
ssh 20.119.234.161     "ulimit -n 20000;cd tapir;bash clients.sh 29 $trd $total_shards $keys" &
